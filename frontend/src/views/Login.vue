    ...
    <div class="max-w-md w-full relative z-10">
      <div class="bg-white/95 backdrop-blur-md rounded-3xl p-8 sm:p-10 shadow-2xl border-2 border-gray-100">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-gray-600 text-base sm:text-lg">Sign in to continue your campaign</p>
        </div>
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div class="text-center pt-2">
            <router-link to="/register" class="text-gray-600 hover:text-blue-600 font-semibold transition-colors duration-200 text-sm sm:text-base">
              Don't have an account? <span class="text-yellow-600 underline">Register Now</span>
            </router-link>
          </div>
        </form>
      </div>
